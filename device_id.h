...
//
// All units flash the same firmware, so a static "hydro-dash" hostname
...
// cores3-hydro uses — yielding e.g. "hydro-dash-a3f2".
//
...
// Returns a stable per-device hostname like "hydro-dash-a3f2".
